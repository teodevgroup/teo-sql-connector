use crate::stmts::drop::database::SQLDropDatabaseStatement;
use crate::stmts::drop::index::SQLDropIndexStatement;
use crate::stmts::drop::table::SQLDropTableStatement;
